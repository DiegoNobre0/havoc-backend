...
export async function catalogRoutes(app: FastifyInstance) {
  ...
  app.post(
    '/products/import-pdf',
    {
      schema: { tags: ['Catálogo - Produtos'], summary: 'Importa PDF do CLIPP e busca imagens' },
    },
    productController.importPDF.bind(productController),
  );
  ...
  app.post(
    '/products/:id/image',
    {
      schema: {
        tags: ['Catálogo - Produtos'],
        summary: 'Upload da imagem principal do produto (JPEG/PNG)',
      },
    },
  ...
  app.withTypeProvider<ZodTypeProvider>().post(
    '/kits',
    {
      schema: {
        tags: ['Catálogo - Kits'],
        summary: 'Cria um novo kit promocional com vários itens',
        body: createKitSchema,
      },
    },
  ...
  app.withTypeProvider<ZodTypeProvider>().delete(
    '/kits/:id',
    {
      schema: {
        tags: ['Catálogo - Kits'],
        summary: 'Remove um kit promocional',
        params: idParamSchema,
      },
    },
  ...
  app.withTypeProvider<ZodTypeProvider>().put(
    '/kits/:id',
    {
      schema: {
        tags: ['Catálogo - Kits'],
        summary: 'Atualiza os dados e os itens de um kit',
        params: idParamSchema,
        body: updateKitSchema,
      },
    },
  ...
  app.post(
    '/kits/:id/image',
    {
      schema: {
        tags: ['Catálogo - Kits'],
        summary: 'Upload de foto promocional do Kit (JPEG/PNG)',
      },
    },
